...
export default function App(): React.JSX.Element {
    ...
    const [accessibilityAnalysisWarning,setAccessibilityAnalysisWarning] = useState<boolean>(false); 
    const changeAccessibilityAnalysisWarning : (accessibilityAnalysisWarning: boolean) => void = (accessibilityAnalysisWarning)=> {
        setAccessibilityAnalysisWarning(accessibilityAnalysisWarning);
    };
    ...
    return(
        <AccessibilityAnalysisContext.Provider value={{accessibilityAnalysis,changeAccessibilityAnalysis}}>
            <AccessibilityAnalysisWarningContext.Provider value={{accessibilityAnalysisWarning,changeAccessibilityAnalysisWarning}}>
            ...
            </AccessibilityAnalysisWarningContext.Provider>
